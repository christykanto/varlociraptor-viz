...
if __name__ == "__main__":
        ...
        chart1.save('event_probabilities_bcf.html')
        print("Saved: event_probabilities_bcf.html")

        print("\nGenerating allele frequency distribution chart")
        chart2 = visualize_allele_frequency_distribution(record, sample_name)
        chart2.save('allele_frequency_distribution_bcf.html')
        print("Saved: allele_frequency_distribution_bcf.html")

        print("\nGenerating observations chart")
        chart3 = visualize_observations(record, sample_name)
        chart3.save('observations_bcf.html')
        print("Saved: observations_bcf.html")
