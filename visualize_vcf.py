...
def visualize_observations(record, sample_name):
    ...
    ref_chart = create_panel(
        ref_observations, "REF", show_y_axis=True, show_legend=False
    )
    alt_chart = create_panel(
        alt_observations, "ALT", show_y_axis=True, show_legend=True
    )
